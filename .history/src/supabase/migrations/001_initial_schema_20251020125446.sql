...
CREATE TABLE quiz_scores (
  ...
  -- Part 1 (Pagbabalik-aral) - 2 questions
  part1_score INTEGER CHECK (part1_score >= 0 AND part1_score <= 2),
  part1_total INTEGER DEFAULT 2,
  part1_percentage NUMERIC(5,2),
  
  -- Part 2 (Pangunahing Quiz) - 2 questions
  part2_score INTEGER CHECK (part2_score >= 0 AND part2_score <= 2),
  part2_total INTEGER DEFAULT 2,
