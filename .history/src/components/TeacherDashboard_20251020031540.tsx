...
import { QuizScore } from '../utils/supabase/client';
                            ...
                            >
                              ...
                              <TableCell>
                                <span className="text-lg">
                                  {getStarRating(
                                    student.part1_score + (student.part2_score || 0),
                                    student.part1_total + (student.part2_total || 5)
                                  )}
                                </span>
                              </TableCell>
                              ...
                              <TableCell className="text-[#0B3D91]/70 text-sm">
                                {new Date(student.created_at).toLocaleDateString('fil-PH', {
                                    year: 'numeric',
                                    month: 'long',
                                    day: 'numeric',
                                    hour: '2-digit',
